...
public abstract class MonsterUnarmed extends Weapon {
	...
	/*
	 * Variables These are custom attribute additions made to the weapon class,
	 * in order to handle monster variants with different |weight| and |speed|
	 * stats.
	 */
	...
	public MonsterUnarmed(String name, Attack attack, int length, int price,
			Weight weight) {
